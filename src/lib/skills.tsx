...
export const skills: Skill[] = [
    ...
    { name: "React Native", icon: <FaReact className='text-white' />, color: "from-black/20 to-white/10" },
    { name: "Git", icon: <FaGit className='text-orange-400' />, color: "from-orange-400/20 to-orange-500/10" },
    { name: "GitHub", icon: <FaGithub className='text-gray-200' />, color: "from-gray-200/20 to-gray-300/10" },
